                ...
                <div className="shadow-lg">
                  <picture className="relative">
                    ...
                    text-xs absolute top-2 left-2 bg-[#d42b42] py-1 px-2 rounded-full text-amber-50`}
                      style={{
                        backgroundColor:
                          item.estadosubasta === 'finalizada'
                            ? '#18208d'
                            : '#d42b42',
                      }}
                    >
                      {item.estadosubasta.toUpperCase()}
                    </span>
                  </picture>
                  <div className="flex flex-col gap-[6px] text-black bg-white p-3 rounded-b-xl h-56">
                    ...
                    <section>
                      <div className="flex justify-between mb-2">
                        <p className="bg-red-600 rounded-md text-white p-1 text-xs ">
                          INICIO
                        </p>
                        <p className="bg-green-600  text-white p-1 text-xs">
                          {item.fecha.inicio}
                        </p>
                      </div>
                      <div className="flex justify-between">
                        ...
                        <p className="bg-green-600 rounded-md text-white p-1 text-xs">
                          {item.fecha.fin}
                        </p>
                      </div>
                    </section>
                    ...
                    <div className="w-full  flex items-stretch mt-auto text-center">
                      {item.estadopost ? (
                        <p className="mx-auto pb-3">En Loteo</p>
                      ) : (
                        <Link
                          href={'/'}
                          className="bg-red-500 text-white w-full py-2 hover:bg-black rounded-sm"
                        >
                          Ver Subasta
                        </Link>
                      )}
